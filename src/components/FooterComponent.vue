<template>
  <footer>
    <div
      ...
      <a href="#" id="voltar" class="flex gap-3 p-2 lg:p-2 justify-center">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="h-6 mt-0.5 lg:mt-1 lg:mb-1">
    ...
    <div class="bg-[#c5a2a6] px-4 py-8 text-white shadow-sm">
      <div class="mx-auto w-full max-w-screen-xl">
        <div class="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul class="space-y-2 text-base font-semibold text-white">
              <li>
                <a href="#" class="hover:text-[#6f4236] hover:underline">Política de Privacidade</a>
              </li>
              <li>
                <a href="#" class="hover:text-[#6f4236] hover:underline">Licenciamento</a>
              </li>
              <li>
                <a href="#" class="hover:text-[#6f4236] hover:underline">Termos e Condições</a>
              </li>
            </ul>
          </div>
        ...
        <div class="flex flex-col items-center text-center md:flex-row md:justify-between md:text-left">
          ...
          <div class="flex space-x-5 rtl:space-x-reverse">
            <a href="#" class="text-white hover:text-pink-900">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-instagram h-6 w-6"
                viewBox="0 0 16 16">
                <path
            ...
            <a href="#" class="text-white hover:text-blue-900">
            ...
            <a href="#" class="text-white hover:text-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter h-6 w-6"
                viewBox="0 0 16 16">
                <path
            ...
            <a href="#" class="text-white hover:text-red-800">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-youtube h-6 w-6"
                viewBox="0 0 16 16">
                <path
            ...
            <a href="#" class="text-white hover:text-blue-800">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-linkedin h-6 w-6"
                viewBox="0 0 16 16">
                <path
